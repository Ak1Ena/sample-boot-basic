...
// //         ResponseEntity<String> deleteResponse = controller.deleteCustomer(cust.getId());
...
// //         assertEquals(0, getResponseAfterDelete.getBody().size());
// //     }
// // }
// package th.mfu;
